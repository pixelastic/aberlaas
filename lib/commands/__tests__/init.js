  ...
  describe('pinNodeAndYarn', () => {
    ...
    describe('yarn', () => {
      it('should run yarn policies if version is outdated', async () => {
        jest.spyOn(current, 'currentYarnVersion').mockReturnValue('1.19.0');
        jest.spyOn(current, 'expectedYarnVersion').mockReturnValue('1.22.0');
      ...
      it('should not run yarn policies if version is matching', async () => {
        jest.spyOn(current, 'currentYarnVersion').mockReturnValue('1.22.0');
        jest.spyOn(current, 'expectedYarnVersion').mockReturnValue('1.22.0');
