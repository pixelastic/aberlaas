...
const lintCss = jestImport('../lint-css');
const lintJson = jestImport('../lint-json');
const lintJs = jestImport('../lint-js');
const lintYml = jestImport('../lint-yml');
const module = jestImport('../lint');
