...
describe('lint', () => {
  ...
  describe('run', () => {
    ...
    it('should display all errors of all linters', async () => {
      ...
      expect(firost.consoleError).toHaveBeenCalledWith('errorCss');
      expect(firost.consoleError).toHaveBeenCalledWith('errorJs');
    });
  ...
  describe('getInputFiles', () => {
    it('should only keep files files in the safelist', async () => {
      await firost.write('foo', helper.hostPath('foo.yml'));
      await firost.write('foo', helper.hostPath('deep/foo.txt'));
    ...
    it('should restrict to patterns given', async () => {
      await firost.write('foo', helper.hostPath('foo.yml'));
      await firost.write('foo', helper.hostPath('deep/foo.yml'));
