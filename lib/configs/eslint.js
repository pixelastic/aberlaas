...
module.exports = {
  ...
  overrides: [
    // ./scripts
    // Disable no-process-exit: We need to set the error code for CI pipelines
    // Disable no-unpublished-require: This folder is not published, so we can
    // safely use devDependencies here
    {
      files: ['**/scripts/**/*.js'],
      rules: {
        'no-process-exit': ['off'],
