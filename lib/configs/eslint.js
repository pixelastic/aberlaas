...
module.exports = {
  ...
  rules: {
    ...
    'node/no-unsupported-features/es-syntax': [
      'error',
      {
        // import/export is valid syntax since Node 13, but the compatibility table
        // of eslint-plugin-node hasn't been updated. There are numerous issues and
        // PR in the repo, but it hasn't been fixed, the minimum version is still
        // null
        // See https://github.com/mysticatea/eslint-plugin-node/blob/master/lib/rules/no-unsupported-features/es-syntax.js#L128
        ignores: ['modules'],
      },
    ],
    // Jest
