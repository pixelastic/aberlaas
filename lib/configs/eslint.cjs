  ...
  overrides: [
    // Vitest
    {
      ...
      rules: {
        ...
        // We are turning this rule off for now, as it doesn't correctly handle
        // the use of fit/xit/fdescribe/xdescribe. It only half-implemented
        // their support, resulting in crashes in some files.
        // I don't think xit/fit is a common pattern in vitest world, so
        // I didn't take the time to submit a PR to eslint-plugin-vitest to fix
        // it
