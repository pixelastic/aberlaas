...
export default {
   ...
   * @param {Array|string} userDefaultValue List of input files to use as default
   * @returns {Array} List of input files
   **/
  inputFromCli(cliArgs, userDefaultValue = []) {
    const defaultValue = _.isArray(userDefaultValue)
      ? userDefaultValue
      : [userDefaultValue];
